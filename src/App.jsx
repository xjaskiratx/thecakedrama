...
const MENU = [
  ...
  { id: 1, name: 'NY-style Baked', category: 'Cheesecakes', image: '/images/ny_baked_cheesecake.webp', priceOptions: [{ id: 'regular', label: 'Regular', price: 800 }, { id: 'large', label: 'Large', price: 1400 }] },
  { id: 2, name: 'Chocolate Mousse', category: 'Cheesecakes', image: '/images/item-800.webp', priceOptions: [{ id: 'regular', label: 'Regular', price: 1000 }, { id: 'large', label: 'Large', price: 1500 }] },
  { id: 3, name: 'Blueberry', category: 'Cheesecakes', image: '/images/item-800.webp', priceOptions: [{ id: 'regular', label: 'Regular', price: 900 }, { id: 'large', label: 'Large', price: 1600 }] },
  { id: 4, name: 'Strawberry', category: 'Cheesecakes', image: '/images/StrawberryCheesecake.webp', priceOptions: [{ id: 'regular', label: 'Regular', price: 900 }, { id: 'large', label: 'Large', price: 1500 }] },
  { id: 5, name: 'Lotus Biscoff', category: 'Cheesecakes', image: '/images/lotus_biscoff_cheesecake.webp', priceOptions: [{ id: 'regular', label: 'Regular', price: 1300 }, { id: 'large', label: 'Large', price: 2000 }] },
  { id: 6, name: 'Nutella', category: 'Cheesecakes', image: '/images/NutellaBrownieCake.webp', priceOptions: [{ id: 'regular', label: 'Regular', price: 1200 }, { id: 'large', label: 'Large', price: 2000 }] },
  { id: 7, name: "Cookies n' cream", category: 'Cheesecakes', image: '/images/item-800.webp', priceOptions: [{ id: 'regular', label: 'Regular', price: 800 }, { id: 'large', label: 'Large', price: 1400 }] },
  { id: 8, name: 'Red Velvet', category: 'Cheesecakes', image: '/images/red_velvet_cheesecake.webp', priceOptions: [{ id: 'regular', label: 'Regular', price: 1000 }, { id: 'large', label: 'Large', price: 1600 }] },
  { id: 9, name: 'Mango', category: 'Cheesecakes', image: '/images/MangoCheesecake.webp', priceOptions: [{ id: 'regular', label: 'Regular', price: 900 }, { id: 'large', label: 'Large', price: 1500 }] },
  { id: 10, name: 'Trio cheesecake', category: 'Cheesecakes', image: '/images/TrioCheesecake.webp', priceOptions: [{ id: 'regular', label: 'Regular', price: 1000 }, { id: 'large', label: 'Large', price: 1700 }] },

  // Tea time cakes (half/full; flavours can be customized; can be wholewheat)
  { id: 11, name: 'Banana Walnut', category: 'Tea time cakes', image: '/images/BananaWalnut.webp', priceOptions: [{ id: 'half', label: 'Half (450-500g)', price: 500 }, { id: 'full', label: 'Full (750-800g)', price: 700 }], flourOptions: [{ id: 'regular', label: 'Regular' }, { id: 'wholewheat', label: 'Wholewheat' }], allowCustomizationNote: true, customizationPlaceholder: 'Wholewheat? Flavour preference? Any customization? Write it here…' },
  { id: 12, name: 'Healthy oats Cake', category: 'Tea time cakes', image: '/images/item-800.webp', priceOptions: [{ id: 'half', label: 'Half (450-500g)', price: 500 }, { id: 'full', label: 'Full (750-800g)', price: 700 }], flourOptions: [{ id: 'regular', label: 'Regular' }, { id: 'wholewheat', label: 'Wholewheat' }], allowCustomizationNote: true, customizationPlaceholder: 'Wholewheat? Flavour preference? Any customization? Write it here…' },
  { id: 13, name: 'Mango crumbled Cake', category: 'Tea time cakes', image: '/images/item-800.webp', priceOptions: [{ id: 'half', label: 'Half (450-500g)', price: 500 }, { id: 'full', label: 'Full (750-800g)', price: 800 }], flourOptions: [{ id: 'regular', label: 'Regular' }, { id: 'wholewheat', label: 'Wholewheat' }], allowCustomizationNote: true, customizationPlaceholder: 'Wholewheat? Flavour preference? Any customization? Write it here…' },
  { id: 14, name: 'Lemon loaf Cake', category: 'Tea time cakes', image: '/images/lemon_loaf_cake.webp', priceOptions: [{ id: 'half', label: 'Half (450-500g)', price: 550 }, { id: 'full', label: 'Full (750-800g)', price: 800 }], flourOptions: [{ id: 'regular', label: 'Regular' }, { id: 'wholewheat', label: 'Wholewheat' }], allowCustomizationNote: true, customizationPlaceholder: 'Wholewheat? Flavour preference? Any customization? Write it here…' },
  { id: 15, name: 'Bundt-Coconut Cake', category: 'Tea time cakes', image: '/images/CreamyCoconut.webp', priceOptions: [{ id: 'half', label: 'Half (450-500g)', price: 500 }, { id: 'full', label: 'Full (750-800g)', price: 750 }], flourOptions: [{ id: 'regular', label: 'Regular' }, { id: 'wholewheat', label: 'Wholewheat' }], allowCustomizationNote: true, customizationPlaceholder: 'Wholewheat? Flavour preference? Any customization? Write it here…' },
  { id: 16, name: 'Orange-glaze Cake', category: 'Tea time cakes', image: '/images/item-800.webp', priceOptions: [{ id: 'half', label: 'Half (450-500g)', price: 500 }, { id: 'full', label: 'Full (750-800g)', price: 700 }], flourOptions: [{ id: 'regular', label: 'Regular' }, { id: 'wholewheat', label: 'Wholewheat' }], allowCustomizationNote: true, customizationPlaceholder: 'Wholewheat? Flavour preference? Any customization? Write it here…' },
  { id: 17, name: 'Pineapple upside-down', category: 'Tea time cakes', image: '/images/item-800.webp', priceOptions: [{ id: 'half', label: 'Half (450-500g)', price: 500 }, { id: 'full', label: 'Full (750-800g)', price: 700 }], flourOptions: [{ id: 'regular', label: 'Regular' }, { id: 'wholewheat', label: 'Wholewheat' }], allowCustomizationNote: true, customizationPlaceholder: 'Wholewheat? Flavour preference? Any customization? Write it here…' },
  { id: 18, name: 'Spiced-plum Cake', category: 'Tea time cakes', image: '/images/item-800.webp', priceOptions: [{ id: 'half', label: 'Half (450-500g)', price: 500 }, { id: 'full', label: 'Full (750-800g)', price: 750 }], flourOptions: [{ id: 'regular', label: 'Regular' }, { id: 'wholewheat', label: 'Wholewheat' }], allowCustomizationNote: true, customizationPlaceholder: 'Wholewheat? Flavour preference? Any customization? Write it here…' },
  { id: 19, name: 'Apple oat-wheat Cake', category: 'Tea time cakes', image: '/images/AppleOat.webp', priceOptions: [{ id: 'half', label: 'Half (450-500g)', price: 500 }, { id: 'full', label: 'Full (750-800g)', price: 750 }], flourOptions: [{ id: 'regular', label: 'Regular' }, { id: 'wholewheat', label: 'Wholewheat' }], allowCustomizationNote: true, customizationPlaceholder: 'Wholewheat? Flavour preference? Any customization? Write it here…' },
  { id: 20, name: "Fruit n' nut Cake", category: 'Tea time cakes', image: '/images/FruitAndNutCake.png', priceOptions: [{ id: 'half', label: 'Half (450-500g)', price: 500 }, { id: 'full', label: 'Full (750-800g)', price: 750 }], flourOptions: [{ id: 'regular', label: 'Regular' }, { id: 'wholewheat', label: 'Wholewheat' }], allowCustomizationNote: true, customizationPlaceholder: 'Wholewheat? Flavour preference? Any customization? Write it here…' },
  { id: 21, name: 'Roasted Almond', category: 'Tea time cakes', image: '/images/item-800.webp', priceOptions: [{ id: 'half', label: 'Half (450-500g)', price: 500 }, { id: 'full', label: 'Full (750-800g)', price: 800 }], flourOptions: [{ id: 'regular', label: 'Regular' }, { id: 'wholewheat', label: 'Wholewheat' }], allowCustomizationNote: true, customizationPlaceholder: 'Wholewheat? Flavour preference? Any customization? Write it here…' },
  { id: 22, name: 'Marble Cake', category: 'Tea time cakes', image: '/images/marble_cake.webp', priceOptions: [{ id: 'half', label: 'Half (450-500g)', price: 500 }, { id: 'full', label: 'Full (750-800g)', price: 700 }], flourOptions: [{ id: 'regular', label: 'Regular' }, { id: 'wholewheat', label: 'Wholewheat' }], allowCustomizationNote: true, customizationPlaceholder: 'Wholewheat? Flavour preference? Any customization? Write it here…' },
  { id: 23, name: 'Mud Cake', category: 'Tea time cakes', image: '/images/mud_cake.webp', priceOptions: [{ id: 'half', label: 'Half (450-500g)', price: 600 }, { id: 'full', label: 'Full (750-800g)', price: 900 }], flourOptions: [{ id: 'regular', label: 'Regular' }, { id: 'wholewheat', label: 'Wholewheat' }], allowCustomizationNote: true, customizationPlaceholder: 'Wholewheat? Flavour preference? Any customization? Write it here…' },

  // Brownies (500g/1kg or single)
  { id: 24, name: 'OG Nutella Fudge Brownie', category: 'Brownies', image: '/images/FudgeBrownies.webp', priceOptions: [{ id: '500g', label: '500g', price: 500 }, { id: '1kg', label: '1kg', price: 800 }] },
  { id: 25, name: 'Biscoff Brownie', category: 'Brownies', image: '/images/item-800.webp', priceOptions: [{ id: '500g', label: '500g', price: 500 }, { id: '1kg', label: '1kg', price: 900 }] },
  { id: 26, name: 'Assorted Brownie box', category: 'Brownies', image: '/images/AssortedBrownies.webp', priceOptions: [{ id: 'box', label: 'Box', price: 600 }] },
  { id: 27, name: 'Crinkled Brownie', category: 'Brownies', image: '/images/item-800.webp', priceOptions: [{ id: '500g', label: '500g', price: 500 }, { id: '1kg', label: '1kg', price: 800 }] },
  { id: 28, name: 'Wholewheat Brownie', category: 'Brownies', image: '/images/item-800.webp', priceOptions: [{ id: '500g', label: '500g', price: 450 }, { id: '1kg', label: '1kg', price: 700 }] },
  { id: 29, name: 'Triple Chocolate Brownie', category: 'Brownies', image: '/images/triple_chocolate_brownie.webp', priceOptions: [{ id: '500g', label: '500g', price: 500 }] },
  { id: 30, name: 'Brownie Bites', category: 'Brownies', image: '/images/NutellaBrownieBites.webp', priceOptions: [{ id: 'single', label: 'Pack', price: 280 }], flavourOptions: [{ id: 'nutella', label: 'Nutella' }, { id: 'biscoff', label: 'Biscoff' }, { id: 'dark', label: 'Dark chocolate' }, { id: 'white', label: 'White chocolate' }], optionsLabel: 'Toppings (optional)', optionsRequired: false, allowCustomizationNote: true, customizationPlaceholder: 'Anything else? (extra toppings, packing note, etc.)' },
  { id: 31, name: 'Brownie w/ Almonds', category: 'Brownies', image: '/images/BrownieWithAlmonds.webp', priceOptions: [{ id: '500g', label: '500g', price: 500 }, { id: '1kg', label: '1kg', price: 800 }] },
];
          ...
          <div className="detail-scroll">
            <div className="detail-image">
              <img
                ...
                srcSet={activeProduct.image === '/images/item-800.webp' ? '/images/item-400.webp 400w, /images/item-800.webp 800w' : undefined}
