...
const MENU = [
  ...
  { id: 20, name: "Fruit n' nut Cake", category: 'Tea time cakes', image: '/images/MixedFruitCake.png', priceOptions: [{ id: 'half', label: 'Half (450-500g)', price: 500 }, { id: 'full', label: 'Full (750-800g)', price: 750 }], flourOptions: [{ id: 'regular', label: 'Regular' }, { id: 'wholewheat', label: 'Wholewheat' }], allowCustomizationNote: true, customizationPlaceholder: 'Wholewheat? Flavour preference? Any customization? Write it here…' },
